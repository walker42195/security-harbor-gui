...
class ApiService {
  ...
  Future<List<SecurityEventModel>> getSecurityEvents({String source = 'live', int limit = 1000, String? severity}) async {
    try {
      ...
      final uri = Uri.parse('$baseUrl/api/v1/diagnostics/security-events').replace(queryParameters: q);
